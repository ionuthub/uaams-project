...
| PRD-DOC-04 | Required evidence gates submission. | UI, database helper and Firestore rules require a non-empty `documentPath`. | Partial | Execute APP-09 against deployed Firebase rules. | Ionut and Dawid | APP-09 test |
