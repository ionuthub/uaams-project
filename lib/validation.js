...
export function mapAuthErrorToMessage(code) {
  switch (code) {
    ...
    // #196: role-scoped sign-in. Both routes override the wrong-portal case
    // with their own copy plus a link, so this is the fallback wording.
    case "app/wrong-portal":
      return "This account cannot sign in here. Check you are using the right sign-in page.";
    case "app/role-check-unavailable":
      return "We could not confirm your account just now. Please try again in a moment.";
