...
export function mapAuthErrorToMessage(code) {
  switch (code) {
    ...
    case "app/missing-firebase-config":
      return "Firebase environment variables are missing on Vercel. Please add NEXT_PUBLIC_FIREBASE_* variables in Vercel settings and redeploy.";
    case "auth/unauthorized-domain":
      return "This Vercel domain is not authorized in Firebase. Add your Vercel URL under Firebase Console > Authentication > Settings > Authorized domains.";
    case "auth/invalid-api-key":
      return "Invalid Firebase API key. Verify NEXT_PUBLIC_FIREBASE_API_KEY in Vercel environment variables and redeploy.";
